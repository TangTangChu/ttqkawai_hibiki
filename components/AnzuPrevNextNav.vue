<template>
    <nav
        ...
        :aria-label="t('common.label.prevNextNav')"
    >
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <NuxtLink
                ...
                :aria-label="`${t('common.action.prevContent')}：${prev.title}`"
            >
                <div
                ...
                >
                    ...
                    <span>{{ t("common.action.prevContent") }}</span>
                </div>
                <div
            ...
            <NuxtLink
                ...
                :aria-label="`${t('common.action.nextContent')}：${next.title}`"
            >
                <div
                ...
                >
                    <span>{{ t("common.action.nextContent") }}</span>
