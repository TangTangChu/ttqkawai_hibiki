        ...
        <section>
            ...
            >
                <div v-for="(project, index) in projects" :key="index">
                    <div
                        class="relative flex flex-col h-full gap-4 rounded-xl p-5 transition-colors duration-200 ease-out bg-surface/30 hover:bg-on-background/2 group"
                    >
                        <div class="flex items-start justify-between gap-4">
                            <h3
                                class="text-lg font-bold text-on-background transition-colors duration-200 group-hover:text-primary truncate"
                            >
                                {{ project.name }}
                            </h3>
                            <div
                                class="flex gap-1.5 flex-wrap justify-end shrink-0 mt-1"
                            >
                                <span
